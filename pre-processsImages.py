...
def intensity_preprocess(A):
    ...
    # remove local median \pm 100 pixels
    #B -=median_filter(B,size=(200,1))
    #B -=median_filter(B,size=(1,200))
...
#Split images where camera errors are detected
split_images = 1

#Images to be processed
img_path="Z:/NSM/simulated_tests/experimental_noise_plus_simulated_DNA/"
#Path to save images
main_save_path ='E:/NSM/Data/Preprocessed Simulated DNA-lambda3/'
#Path to save ground truth trajectories (for simulated data)
saveTrajPath="E:/NSM/Data/Preprocessed Simulated DNA-lambda Ground Truth/"
...
for folder in tqdm.tqdm(folders):
    ...
    save_traj_path=saveTrajPath+folder
    ...
    try:
       os.makedirs(save_traj_path, exist_ok=True)
        ...
        print()
        print('Directory:' + save_traj_path + ' already exists, passing.')
        continue
